...
export default function Home() {
  return (
    <div className="max-w-[988px] mx-auto flex-1 w-full flex flex-col lg:flex-col items-center justify-center p-4 gap-2 pt-24 lg:pt-44">
      <Hero />
      <div className="my-5">In Kenniscentrum you can do the following with the help of AI:</div>
      <div className="max-w-xl w-full flex flex-col space-y-3 md:space-y-0 md:flex-row justify-evenly ">
